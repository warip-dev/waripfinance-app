    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
      <div className="bg-gray-800 p-8 md:p-10 rounded-2xl max-w-md w-full text-center">
        ...
        <div className="space-y-3 text-gray-300">
          ...
          <p className="text-gray-400">Vérification en cours par notre équipe...</p>
          <p className="text-gray-400">Vous recevrez un email une fois votre inscription validée.</p>
        </div>
        <div className="mt-6 p-4 bg-gray-700/50 rounded-lg">
          <p className="text-sm text-gray-400">En attendant, vous pouvez consulter notre <Link to="/" className="text-gold hover:underline">page d'accueil</Link></p>
        </div>
        <p className="text-sm text-gray-500 mt-6">Merci de votre confiance, L'équipe Warip Finance</p>
      </div>
    </div>
  );
};

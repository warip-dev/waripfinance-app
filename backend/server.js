...
(async () => {
    try {
        ...
        `);
        console.log('✅ Table beneficiaries créée');
        ...
        `);
        console.log('✅ Table transfers créée');
        ...
        `);
        console.log('✅ Table deposit_addresses créée');
...
app.get('/beneficiary.html', (req, res) => res.sendFile(path.join(__dirname, 'public', 'beneficiary.html')));
app.get('/add-beneficiary.html', (req, res) => res.sendFile(path.join(__dirname, 'public', 'add-beneficiary.html')));
app.get('/transfer.html', (req, res) => res.sendFile(path.join(__dirname, 'public', 'transfer.html')));

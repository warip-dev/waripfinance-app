...
(async () => {
    try {
        ...
        `);
        console.log('✅ Table beneficiaries créée/vérifiée');
        ...
        `);
        console.log('✅ Table deposit_addresses créée/vérifiée');
...
app.post('/api/auth/register', async (req, res) => {
    try {
        const {
            ...
            phone, city, postal_code, street_name, street_number,
        ...
        const [result] = await pool.execute(
            `INSERT INTO users (
                ...
                profession, gender, marital_status, status, role
            ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
            [

...
// ============================================
// CRÉATION DES TABLES (avec toutes les colonnes)
// ============================================
(async () => {
    try {
        await pool.execute(`
...
// ============================================
// ADMIN - BÉNÉFICIAIRES (validation)
// ============================================
...
app.get('/api/beneficiaries', async (req, res) => {
    try {
        ...
        // Pour simplifier, on prend l'utilisateur 1 (à remplacer par JWT)
